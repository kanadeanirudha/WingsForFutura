...
namespace Coditech.DataAccessLayer.Repository
{
    public class CoditechViewRepository<T>
    {
        #region Declarations
        ...
        public CoditechViewRepository(IDBContext context)
        {
            _context = context;
        }
        ...
        public IList<T> ExecuteStoredProcedureList(string commandText, int storedProcedureTimeout, int? indexOutParamater, out int totalRowCount)
        {
            ...
            {
                CoditechFileLogging.LogObject(typeof(T), commandText, ex);
                throw;
            }
            finally
            {
