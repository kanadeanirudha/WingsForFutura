...
using Coditech.DataAccessLayer.Extensions;
...
namespace Coditech.DataAccessLayer.DataEntity
{
    public class CoditechRepository<T> : ICoditechRepository<T> where T : class
    {
        ...
        public virtual bool IsUserWantToDebugSql { get; set; } = CoditechSetting.IsUserWantToDebugSql;
        ...
        public CoditechRepository(IDBContext context)
        {
            _context = context;
            #if DEBUG
             if (IsUserWantToDebugSql)
        ...
        public virtual T Insert(T entity)
        {
            ...
            catch (Exception ex)
            {
                ...
                CoditechFileLogging.LogObject(typeof(T), entity, ex);
                throw;
            }
            return entity;
        }
        ...
        public virtual IEnumerable<T> Insert(IEnumerable<T> entities)
        {
            ...
            catch (Exception ex)
            {
                ...
                CoditechFileLogging.LogObject(typeof(IEnumerable<T>), entities, ex);
                throw;
            }
        }
        ...
        public virtual bool BatchUpdate(IEnumerable<T> entities)
        {
            ...
            {
                CoditechFileLogging.LogObject(typeof(T), entities, ex);
                throw;
            }
        }
        ...
        public virtual bool Delete(string whereClause, object[] values)
        {
            ...
            {
                CoditechFileLogging.LogObject(typeof(IEnumerable<T>), whereClause, ex);
                throw;
            }
        }
        ...
        public virtual T GetEntity(string where, List<string> navigationProperties, object[] values)
        {
            ...
            {
                CoditechFileLogging.LogObject(typeof(T), item, ex);
                throw;
            }
            return item;
        }
        ...
        public virtual IList<T> GetEntityList(string where, string orderBy, List<string> navigationProperties, object[] values)
        {
            ...
            {
                CoditechFileLogging.LogObject(typeof(IList<T>), list, ex);
                throw;
            }
            return list;
        }
        ...
        public virtual IList<T> GetPagedList(string where, string orderBy, List<string> navigationProperties, object[] values, int pageIndex, int pageSize, out int totalCount)
        {
            ...
            {
                totalCount = 0;
                CoditechFileLogging.LogObject(typeof(T), list, ex);
                throw;
            }
            return list;
        }
        ...
        private EntitySet GetEntitySet<TEntity>() where TEntity : class
        {
            ...
            {
                CoditechFileLogging.LogObject(typeof(TEntity), entitySet, ex);
                throw;
            }
            return entitySet;
        }
